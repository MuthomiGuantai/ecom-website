...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Krystol's WhatNots</title>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand">Krystol's WhatNots</a>
			</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<form onsubmit="return false" id="login">
							...
							<p><br/></p>
							<a a href="register.php">No account?sign up HERE</a><input type="submit" class="btn btn-success" style="float:right;" Value="Register">
